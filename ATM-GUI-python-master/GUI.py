...
class Main_Window():
    ...
    def startWindow(self):
        ...
        btn = tkinter.Button(StartW, text="Start", width=10,
                             command=self.mainWindowInit)
    ...
    def mainWindowInit(self):
        ...
        rd2 = tkinter.Radiobutton(
            self.mainW, text="User", variable=self.var, value=1)
    ...
    def User(self):
        ...
        rd1 = tkinter.Radiobutton(
            self.usrW, text="Current User", variable=self.varU, value=0)
        rd2 = tkinter.Radiobutton(
            self.usrW, text="  New User  ", variable=self.varU, value=1)
    ...
    def deleteAccInit(self):
        ...
        # Button
        BTN = tkinter.Button(self.deleteAccW, text="Enter",
                             width=10, command=self.deleteAccBtn)
    ...
    def getDataInit(self):
        ...
        Lbl.grid(row=1, column=1)
        # Button
        BTN = tkinter.Button(self.getDataW, text="Enter",
                             width=10, command=self.getDataBtn)
        BTN.grid(row=5, column=2)
        # Entry
    ...
    def searchNameInit(self):
        ...
        Lbl.grid(row=1, column=1)
        # Button
        BTN = tkinter.Button(self.searchNameW, text="Enter",
                             width=10, command=self.searchNameBtn)
        BTN.grid(row=5, column=2)
        # Entry
    ...
    def printAccData(self, list, id):
        ...
        # Button
        BTN = tkinter.Button(self.printAccDataW, text="Close",
                             width=10, command=self.printAccDataW.destroy)
...
class New_User():
    ...
    def newUser(self):
        ...
        Enter_Button = tkinter.Button(
            self.nUsrW, text="Enter", command=self.newUserBtn)
...
class Current_User():
    ...
    def curUser(self):
        ...
        # Button
        BTNLogin = tkinter.Button(
            self.curUsrW, text="Enter", width=10, command=self.curUserBtn)
    ...
    def curUserBtn(self):
        ...
        if self.ID in DB:
            if DB[self.ID][1] == "running":
                ...
                # Enter Button
                BTNCorr = tkinter.Button(
                    self.curUsrPsW, text="Enter", width=10, command=self.curUsrPsBtn)
                ...
                ShowMSG("Account Locked, please go to the branch",
                        x="350", title="Error")
    ...
    def curUsrPsBtn(self):
        ...
        # Wrong Password
            ...
            # label
            LblLogin = tkinter.Label(
                self.curUsrPsW, text="Wrong Password, Trail Number: " + str(self.trails))
            LblLogin.grid(row=2, column=3)
            self.trails += 1
            if self.trails == 4:
                DB[self.ID][1] = "locked"
    ...
    def serv(self):
        ...
        while i < col_num:
            ...
            i += 1
        BTNC = tkinter.Button(self.servW, text="Cash Withdraw",
                              width=15, command=self.cashInit)
        BTNC.grid(row=1, column=1)
        BTNB = tkinter.Button(self.servW, text="Balance Inquiry",
                              width=15, command=self.balanceInit)
        BTNB.grid(row=2, column=1)
        BTNP = tkinter.Button(
            self.servW, text="Password Change", width=15, command=self.passInit)
        BTNP.grid(row=3, column=1)
        BTNF = tkinter.Button(self.servW, text="Fawry Service",
                              width=15, command=self.fawryInit)
        BTNF.grid(row=4, column=1)
        BTNL = tkinter.Button(self.servW, text="Logout",
                              width=15, command=self.servW.destroy)
        BTNL.grid(row=6, column=1)
        BTNE = tkinter.Button(self.servW, text="Exit",
                              width=15, command=exitBtn)
    ...
    def cashInit(self):
        ...
        # Button
        BTNCash = tkinter.Button(
            self.cashW, text="Enter", width=10, command=self.cashBtn)
    ...
    def balanceInit(self):
        ...
        while i < col_num:
            ...
            i += 1
        # label For Name
        LblBal = tkinter.Label(self.balanceW, text=(
            "Your Name: " + str(self.Data[0])))
        LblBal.grid(row=2, column=2)
        # label For Balance
        LblBal2 = tkinter.Label(self.balanceW, text=(
            "Your Balance: " + str(self.Data[2])))
        LblBal2.grid(row=3, column=2)
        # Button
        BTNBal = tkinter.Button(self.balanceW, text="OK",
                                width=10, command=self.balanceW.destroy)
    ...
    def passInit(self):
        ...
        # Button
        BTNPC = tkinter.Button(
            self.chPasW, text="Change Password", width=20, command=self.chPasBtn)
    ...
    def chPasBtn(self):
        ...
        if val1 != val2:
            # label
            LblPass = tkinter.Label(
                self.chPasW, text="   passwords must match                  ")
        ...
        # Check if password with length four
            ...
            # label
            LblPass = tkinter.Label(
                self.chPasW, text="password must be with length four")
            LblPass.grid(row=3, column=1)
            return
        else:
    ...
    def fawryInit(self):
        ...
        self.fawryW.title("Fawry Service")
        i = 0
        while i < 10:
        ...
        while i < col_num:
            ...
            i += 1
        BTNO = tkinter.Button(
            self.fawryW, text="Orange Recharge", width=15, command=self.fawryChargeBtn)
        BTNO.grid(row=1, column=1)
        BTNE = tkinter.Button(
            self.fawryW, text="Etisalat Recharge", width=15, command=self.fawryChargeBtn)
        BTNE.grid(row=2, column=1)
        BTNV = tkinter.Button(
            self.fawryW, text="Vodafone Recharge", width=15, command=self.fawryChargeBtn)
        BTNV.grid(row=3, column=1)
        BTNW = tkinter.Button(self.fawryW, text="We Recharge",
                              width=15, command=self.fawryChargeBtn)
        BTNW.grid(row=4, column=1)
        BTNC = tkinter.Button(self.fawryW, text="Close",
                              width=15, command=self.fawryW.destroy)
    ...
    def fawryChargeBtn(self):
        ...
        self.fawryChargeW.title("Fawry Service")
        i = 0
        while i < 6:
        ...
        # Button
        BTNFB = tkinter.Button(
            self.fawryChargeW, text="Enter", width=10, command=self.rechargeBtn)
    ...
    def rechargeBtn(self):
        ...
        if (val.isnumeric() == True) and (self.fawryNum_Entry.get().isnumeric() == True):
            ...
            # label
            LblCash = tkinter.Label(
                self.fawryChargeW, text="    Numeric Only    ")
            LblCash.grid(row=3, column=2)
            return
        # Check if value is less or equal Balance
        if val <= int(self.Data[2]):
...
def ShowMSG(msg, x="200", title="Message", BtnText="Close"):
    ...
    # Button
    BTNMSG = tkinter.Button(winMSG, text=BtnText,
                            width=10, command=winMSG.destroy)
